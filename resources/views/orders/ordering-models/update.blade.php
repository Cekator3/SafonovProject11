...
@section('title', 'Изменение '.$model->getName().' в заказе №'.$model->getOrderId())
...
@section('main')
<header>
    <h1>Изменение <strong>{{ $model->getName() }}</strong> в заказе №{{ $model->getOrderId() }}</h1>
</header>

<form method="POST"
      action="{{ route('shopping-cart.update', ['orderedModelId'=> $model->getIdInOrder()]) }}"
>
    @csrf
    @method('PUT')
            ...
            <li class="option">
                <div class="description">
                    <x-forms.inputs.checkbox-radio :type=" 'radio' "
                                                   ...
                                                   :checked=" $printingTechnology->isSelected() "
            ...
            <li class="option">
                <div class="description">
                    <x-forms.inputs.checkbox-radio :type=" 'radio' "
                                                   ...
                                                   :checked=" $filamentType->isSelected() "
            ...
            <li class="option">
                <div class="description">
                    <x-forms.inputs.checkbox-radio :name=" 'additional-services[]' "
                                                   ...
                                                   :checked=" $additionalService->isSelected() "
